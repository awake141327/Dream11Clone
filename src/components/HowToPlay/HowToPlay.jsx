    ...
    <section className="howtoplay-section" id="how-to-play">
      ...
      <div className="app-para">
        <p>
          ...
          play on Dream11 and get started now. Compete with sports fans, make a
          perfect Dream11 team with the best combination of players as per your
      ...
      <div className="review-rating-section">
        ...
        <div className="rating-star-box">
          ...
          4.7 | <span className="text-gray">2,750,143 ratings</span>
        </div>
      </div>
    </section>
  );
